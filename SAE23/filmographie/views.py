...
def ajouter_commentaire(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('lister_films')  # ou une autre page appropriée
    else:
